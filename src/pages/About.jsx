        ...
        <div className="pt-4 inline-flex">
          ...
          <div>
            ...
            <a href={`${process.env.PUBLIC_URL}/Erson_Pereira.pdf`} download="Erson_Pereira_Software_Dev" target="_blank" rel="noreferrer">
              <button type="button" className="bg-secondary-color dark:bg-primary-color text-primary-color dark:text-secondary-color py-0.5 px-4 rounded-full items-center">
                <div className="flex flex-grow">
                  CV&nbsp;
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="fill-current mt-1 fill-primary-color dark:fill-secondary-color" viewBox="0 0 16 16">
