  ...
  return (
    <MainLayout>
      <div className="container w-full md:max-w-7xl mx-auto pb-16 pl-4 pr-4 max-w-md overflow-hidden pt-16">
        ...
        <div className="container w-full max-w-7xl mx-auto pt-1 overflow-hidden flex">
          <div className="flex-grow flex w-auto flex-col md:flex-row flex-wrap list-none mb-4">
            <div className="flex-grow pr-2 pb-2 break-normal w-22 ">
              If you&apos;d like to send me a message, you can reach out through various ways!
              <br />
        ...
        <a href="https://www.linkedin.com/in/ersonpereira/" title="Linkedin" target="_blank" rel="noreferrer" className="pr-4 py-2 flex hover:underline decoration-4">
        ...
        <a href="https://github.com/ersonp" title="GitHub" target="_blank" rel="noreferrer" className="pr-4 py-2 flex hover:underline decoration-4">
        ...
        <a href="https://t.me/ersonp" title="Telegram" target="_blank" rel="noreferrer" className="pr-4 py-2 flex hover:underline decoration-4">
